	...
	return (
		<div className="h-screen flex text-gray-300 bg-gray-950">
			<div className="mx-auto mt-8">
				{win && (
					<div className="rounded-md border-1-4 border-green-500 bg-green-100 p-2 mb-2">
				...
				<div className="px-6 mt-4">
					<button
						onClick={newGame}
						className="text-black font-bold vlock bg-gray-900 p-2 rounded w-full h-full bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
						New Game
					</button>
				</div>
			</div>
